...
import { YakUIComponent, YakUIHorizontalAlignment } from "./component";
...
export declare class ElTableColumn extends YakUIComponent {
  ...
  headerAlign: YakUIHorizontalAlignment;
