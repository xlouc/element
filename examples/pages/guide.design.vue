<template>
  <div class="guide-design">
    ...
    <el-row :gutter="14" class="cards">
      <el-col :xs="12" :sm="6">
        <div class="card">
          <img :src="$assets['consistency']" alt="Consistency" />
          <h4>一致</h4>
      ...
      <el-col :xs="12" :sm="6">
        <div class="card">
          <img :src="$assets['feedback']" alt="Feedback" />
          <h4>反馈</h4>
          <span>Feedback</span>
        </div>
      </el-col>
      <el-col :xs="12" :sm="6">
        <div class="card">
          <img :src="$assets['efficiency']" alt="Efficiency" />
          <h4>效率</h4>
      ...
      <el-col :xs="12" :sm="6">
        <div class="card">
          <img :src="$assets['controllability']" alt="Controllability" />
          <h4>可控</h4>
