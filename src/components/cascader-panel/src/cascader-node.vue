...
import { isEqual } from 'yak-ui/src/utils/util'
...
export default {
  ...
  methods: {
    ...
    renderLoadingIcon(h) {
      return (
        <i class="el-cascader-node__postfix el-icon-loading anticon">
    ...
    renderExpandIcon(h) {
      return <i class="el-icon-right el-cascader-node__postfix"></i>
    },
