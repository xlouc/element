    ...
    >
      <template slot="suffix">
        ...
        <i
          v-else
          key="down"
          :class="['el-input__icon', 'el-icon-down', dropDownVisible && 'is-reverse']"
...
import ElTag from 'yak-ui/components/tag'
import ElScrollbar from 'yak-ui/components/scrollbar'
import ElCascaderPanel from 'yak-ui/components/cascader-panel'
